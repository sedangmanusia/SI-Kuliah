            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-border.html">Data Ruang</a>
                        <a class="collapse-item" href="utilities-animation.html">Jadwal Pelajaran</a>
                        <a class="collapse-item" href="utilities-other.html">Nilai</a>
                    </div>
                </div>
            </li>
